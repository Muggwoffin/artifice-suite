...
from app.db.models import SpeakerMapping, TranscriptionJob, TranscriptSegment
...
async def export_tei(db: AsyncSession, job_id: str) -> str:
    ...
    ET.SubElement(publicationStmt, f"{{{TEI_NS}}}p").text = "Generated by PersonaeTranscribe"
