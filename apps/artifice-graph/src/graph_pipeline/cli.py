...
from graph_pipeline.config import load_config
...
from graph_pipeline.models.entity import Entity
...
def _build_resolver(
    ...
    from graph_pipeline.config import PipelineConfig
...
def demo() -> None:
    ...
    from graph_pipeline.models.entity import Entity as EntityModel, EntityType
    from graph_pipeline.models.relationship import Relationship as RelModel
