...
> **Development status: Paused (2026-09-09).** Current local-model quality for open-ended
> copy-editing doesn't yet clear this suite's bar, so active feature work is on hold in favour of
> Artifice OCR and Artifice Transcribe. ArtificeDraft remains installable, published, and covered
> by its existing test suite — this is a pause on new investment, not a removal. See the
> [suite README](../../README.md#development-status) for the full picture.
