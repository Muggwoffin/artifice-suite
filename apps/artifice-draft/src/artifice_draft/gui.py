...
class EditGUI:
    ...
    def _do_import_text(self, win, text):
        self._import_guide_impl(
            win, lambda cfg: (
                __import__("artifice_draft.style_guides.scraper", fromlist=["preview_guide_from_text"])
    ...
    def _do_import_file(self, win, path):
        self._import_guide_impl(
            win, lambda cfg: (
                __import__("artifice_draft.style_guides.scraper", fromlist=["preview_guide_from_file"])
