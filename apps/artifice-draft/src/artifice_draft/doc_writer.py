...
def apply_edits_to_docx(
    ...
    """
    from artifice_draft._track_changes import apply_track_changes_to_docx
...
def apply_edits(
    ...
    if export_format == ExportFormat.DOCX_TRACK_CHANGES:
        ...
        from artifice_draft.exporters import export
        fmt_map = {
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        print("Usage: python -m artifice_draft.doc_writer <paragraphs.json> <output.docx>")
        sys.exit(1)
